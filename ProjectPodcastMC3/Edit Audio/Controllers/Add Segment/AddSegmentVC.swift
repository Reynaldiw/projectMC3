//
//  AddSegmentVCViewController.swift
//  ProjectPodcastMC3
//
...
class AddSegmentVC: UIViewController {
    ...
    var addSegmentView: AddSegmentView { return self.view as! AddSegmentView }
    ...
    private func initInterfaceComponent() {
        editSegmentCV = addSegmentView.editSegmentCV
        editSegmentCV.register(AddSegmentCell.self, forCellWithReuseIdentifier: Constants.KEY_ADD_SEGMENT_CELL)
        editSegmentCV.delegate = self
        editSegmentCV.dataSource = self
        
        segmentView = addSegmentView.startSegmentView
        
        timePickerView = addSegmentView.startSegmentView.timePicker
    ...
    private func changeStatusViewToEditSegment() {
        title = "Edit Segment Duration"
        type = .Edit
...
extension AddSegmentVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: Constants.KEY_ADD_SEGMENT_CELL, for: indexPath) as! AddSegmentCell
...
extension AddSegmentVC: UIPickerViewDelegate, UIPickerViewDataSource {
