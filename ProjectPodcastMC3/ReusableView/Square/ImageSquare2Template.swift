...
class TemplateKotak1: UIView {
        ...
        var waveformImage: UIImageView = {
            let img = UIImageView()
            img.image = UIImage(named: "WaveForm")
            //img.tintColor = .red
            //img.contentMode = .scaleToFill
            //img.layer.applySketchShadow(color: .black, alpha: 0.11, x: -1, y: 2, blur: 3, spread: 0)
            //img.addBlurEffect()
        ...
        override init(frame: CGRect) {
            ...
            contentView.addSubview(contentImage)
            contentImage.anchor(top: nil, bottom: nil, leading: nil, trailing: nil, marginTop: 0, marginBottom: 0, marginLeading: 0, marginTrailing: 0, width: 202, height: 354, centerX: centerXAnchor, centerY: centerYAnchor, marginFromCenterX: 0, marginFromCenterY: -30)
