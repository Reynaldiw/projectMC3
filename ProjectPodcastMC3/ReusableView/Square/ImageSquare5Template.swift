...
class ImageSquare5Template: UIView {

    let contentView = UIView()
        var backgroundImage: UIImageView = {
            let img = UIImageView()
            img.image = UIImage(named: "TemplateKotak3")
        ...
        override init(frame: CGRect) {
            ...
            boxBlack.anchor(top: contentView.topAnchor, bottom: nil, leading: nil, trailing: nil, marginTop: 40, marginBottom: 0, marginLeading: 0, marginTrailing: 0, width: 224, height: 38, centerX: centerXAnchor, centerY: nil, marginFromCenterX: 0, marginFromCenterY: 0)
            
            
            contentView.addSubview(contentText)
            contentText.anchor(top: contentView.topAnchor, bottom: nil, leading: nil, trailing: nil, marginTop: 48, marginBottom: 0, marginLeading: 0, marginTrailing: 0, width: 0, height: 0, centerX: centerXAnchor, centerY: nil, marginFromCenterX: 0, marginFromCenterY: 0)
        }
