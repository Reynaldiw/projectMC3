...
class ImagePotrait6Template: UIView {
    ...
    let contentView = UIView()
        ...
        override init(frame: CGRect) {
            ...
            contentImage.anchor(top: nil, bottom: nil, leading: nil, trailing: nil, marginTop: 0, marginBottom: 0, marginLeading: 0, marginTrailing: 0, width: 240, height: 240, centerX: centerXAnchor, centerY: centerYAnchor, marginFromCenterX: 0, marginFromCenterY: 0)
            
            contentView.addSubview(waveformImage)
            waveformImage.anchor(top: contentView.topAnchor, bottom: nil, leading: contentView.leadingAnchor, trailing: contentView.trailingAnchor, marginTop: 48, marginBottom: 0, marginLeading: 0, marginTrailing: 0, width: 0, height: 48, centerX: nil, centerY: nil, marginFromCenterX: 0, marginFromCenterY: 0)
            
            contentView.addSubview(contentText)
            contentText.anchor(top: nil, bottom: contentView.bottomAnchor, leading: nil, trailing: nil, marginTop: 0, marginBottom: -48, marginLeading: 0, marginTrailing: 0, width: 0, height: 0, centerX: centerXAnchor, centerY: nil, marginFromCenterX: 0, marginFromCenterY: 0)
        }
