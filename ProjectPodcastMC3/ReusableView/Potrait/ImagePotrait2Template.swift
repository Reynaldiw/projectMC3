...
class ImagePotrait2Template: UIView {

let contentView = UIView()
    var backgroundImage: UIImageView = {
        let img = UIImageView()
        img.image = UIImage(named: "TemplatePotrait1")
    ...
    override init(frame: CGRect) {
        ...
        contentImage.anchor(top: contentView.topAnchor, bottom: nil, leading: nil, trailing: nil, marginTop: 50, marginBottom: 0, marginLeading: 0, marginTrailing: 0, width: 202, height: 354, centerX: centerXAnchor, centerY: nil, marginFromCenterX: 0, marginFromCenterY: 0)
