...
class ImagePotrait5Template: UIView {

    let contentView = UIView()
        var backgroundImage: UIImageView = {
            let img = UIImageView()
            img.image = UIImage(named: "TemplatePotrait4")
        ...
        override init(frame: CGRect) {
            ...
            waveformImage.anchor(top: nil, bottom: contentView.bottomAnchor, leading: contentView.leadingAnchor, trailing: contentView.trailingAnchor, marginTop: 0, marginBottom: -128, marginLeading: 0, marginTrailing: 0, width: 0, height: 48, centerX: nil, centerY: nil, marginFromCenterX: 0, marginFromCenterY: 0)
            
            
            contentView.addSubview(boxBlack)
            boxBlack.anchor(top: nil, bottom: contentView.bottomAnchor, leading: nil, trailing: nil, marginTop: 0, marginBottom: -56, marginLeading: 0, marginTrailing: 0, width: 272, height: 48, centerX: centerXAnchor, centerY: nil, marginFromCenterX: 0, marginFromCenterY: 0)
            
            
            contentView.addSubview(contentText)
            contentText.anchor(top: nil, bottom: contentView.bottomAnchor, leading: nil, trailing: nil, marginTop: 0, marginBottom: -66, marginLeading: 0, marginTrailing: 0, width: 0, height: 0, centerX: centerXAnchor, centerY: nil, marginFromCenterX: 0, marginFromCenterY: 0)
        }
